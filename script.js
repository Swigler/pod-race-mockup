...
<body>
    ...
    <div class="backend-config" style="margin-bottom: 20px; padding: 15px; background-color: #f8f9fa; border-radius: 8px; border: 1px solid #ddd;">
        <h3>Backend Configuration</h3>
        <p>Configure the URL of your backend API server:</p>
        <input type="text" id="backendUrl" value="http://localhost:9000" style="width: 80%; padding: 8px; border: 1px solid #ddd; border-radius: 4px;">
